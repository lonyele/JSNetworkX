...
var testDeepcopy = {
  'it deep copies normal objects and arrays': function itDeepCopiesNormalObjectsAndArrays() {
    var foo = [1, 2];
    var obj = {
      foo: foo,
      bar: ['bar', foo]
  ...
  'it deep copies maps': function itDeepCopiesMaps() {
    var foo = [1, 2, 3];
    var bar = new _Map2['default']([[1, foo], [2, foo]]);
    var map = new _Map2['default']([[1, foo], [2, bar]]);
