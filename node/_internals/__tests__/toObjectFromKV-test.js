...
var testToObjectFromKV = {
  ...
  'generate object from array of pairs': function generateObjectFromArrayOfPairs() {
    var obj = (0, _toObjectFromKV2['default'])([['foo', 5], [10, [1, 2]]]);
    assert.deepEqual(obj, { foo: 5, 10: [1, 2] });
  },

  'generate empty object from empty array': function generateEmptyObjectFromEmptyArray() {
