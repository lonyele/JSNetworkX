...
var testSet = {
  ...
  difference: {
    'single argument - different set, same elements': function singleArgumentDifferentSetSameElements() {
      var set = new _Set2['default']([1, 2, 3]);
    ...
    'two arguments': function twoArguments() {
      var diff = new _Set2['default']([1, 2, 3, 4]).difference(new _Set2['default']([2, 4]));

      assert.deepEqual(diff, new _Set2['default']([1, 3]));
    },

    'multiple arguments': function multipleArguments() {
      var diff = new _Set2['default']([1, 2, 3, 4]).difference(new _Set2['default']([2, 6]), new _Set2['default']([4]));
  ...
  intersection: {
    'two arguments': function twoArguments() {
      var diff = new _Set2['default']([1, 2, 3, 4]).intersection(new _Set2['default']([2, 4]));

      assert.deepEqual(diff, new _Set2['default']([2, 4]));
    },

    'multiple arguments': function multipleArguments() {
      var diff = new _Set2['default']([1, 2, 3, 4]).intersection(new _Set2['default']([2, 6]), new _Set2['default']([2, 4]));
...
var testSymmetricDifference = {
  ...
  'sets with common elements': function setsWithCommonElements() {
    ...
    assert.deepEqual((0, _Set.symmetricDifference)(a, b), new _Set2['default']([1, 2, 5, 6]));
    assert.deepEqual((0, _Set.symmetricDifference)(b, a), new _Set2['default']([1, 2, 5, 6]));
  },

  'sets without common elements': function setsWithoutCommonElements() {
    var a = new _Set2['default']([1, 2]);
    var b = new _Set2['default']([3, 4]);
    assert.deepEqual((0, _Set.symmetricDifference)(a, b), new _Set2['default']([1, 2, 3, 4]));
    assert.deepEqual((0, _Set.symmetricDifference)(b, a), new _Set2['default']([1, 2, 3, 4]));
  }
};
...
var testUnion = {
  ...
  'sets with common elements': function setsWithCommonElements() {
    var a = new _Set2['default']([1, 2, 3, 4]);
    var b = new _Set2['default']([3, 4, 5, 6]);
    assert.deepEqual((0, _Set.union)(a, b), new _Set2['default']([1, 2, 3, 4, 5, 6]));
    assert.deepEqual((0, _Set.union)(b, a), new _Set2['default']([1, 2, 3, 4, 5, 6]));
  },
