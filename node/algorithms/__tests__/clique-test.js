...
var clique = {
  ...
  beforeEach: function beforeEach() {
    ...
    this.G = (0, _relabel.convertNodeLabelsToIntegers)((0, _generators.havelHakimiGraph)(z), 1);
  ...
  testNumberOfCliques: function testNumberOfCliques() {
    ...
    assert.deepEqual((0, _clique.numberOfCliques)(G, [1]), new utils.Map({ 1: 1 }));
    assert.deepEqual((0, _clique.numberOfCliques)(G, [1, 2]), new utils.Map({ 1: 1, 2: 2 }));
    assert.deepEqual((0, _clique.numberOfCliques)(G, 2), 2);

    assert.deepEqual((0, _clique.numberOfCliques)(G), new utils.Map({ 1: 1, 2: 2, 3: 1, 4: 2, 5: 1,
      6: 2, 7: 1, 8: 1, 9: 1, 10: 1, 11: 1 }));

    assert.deepEqual((0, _clique.numberOfCliques)(G, G.nodes()), new utils.Map({ 1: 1, 2: 2, 3: 1, 4: 2, 5: 1,
      6: 2, 7: 1, 8: 1, 9: 1, 10: 1, 11: 1 }));

    assert.deepEqual((0, _clique.numberOfCliques)(G, [2, 3, 4]), new utils.Map({ 2: 2, 3: 1, 4: 2 }));

    assert.deepEqual((0, _clique.numberOfCliques)(G, null, this.cl), new utils.Map({ 1: 1, 2: 2, 3: 1, 4: 2, 5: 1,
      6: 2, 7: 1, 8: 1, 9: 1, 10: 1, 11: 1 }));

    assert.deepEqual((0, _clique.numberOfCliques)(G, G.nodes(), this.cl), new utils.Map({ 1: 1, 2: 2, 3: 1, 4: 2, 5: 1,
      6: 2, 7: 1, 8: 1, 9: 1, 10: 1, 11: 1 }));
  }
