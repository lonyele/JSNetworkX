...
var _exceptionsJSNetworkXException2 = _interopRequireDefault(_exceptionsJSNetworkXException);
...
var graphical = {
  ...
  testValidDegreeSequence1: function testValidDegreeSequence1() {
    ...
    for (var i = 0; i < 10; i++) {
      ...
      var deg = G.degree();
      assert.ok((0, _graphical.isValidDegreeSequence)(deg.values(), /*method=*/'eg'), 'eg');
      assert.ok((0, _graphical.isValidDegreeSequence)(deg.values(), /*method=*/'hh'), 'hh');
    }
  },
