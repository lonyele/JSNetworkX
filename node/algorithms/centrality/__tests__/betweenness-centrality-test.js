...
var testBetweennessCentrality = {
  testk5: function testk5() {
    ...
    var b = (0, _betweenness.betweennessCentrality)(G, { weight: null, normalized: false });
  ...
  testk5Endpoints: function testk5Endpoints() {
    ...
    var b = (0, _betweenness.betweennessCentrality)(G, { weight: null, normalized: false, endpoints: true });
    assert.deepEqual(b, bAnswer);
  },
  ...
  testP3Normalized: function testP3Normalized() {
    ...
    var b = (0, _betweenness.betweennessCentrality)(G, { weight: null, normalized: true });
    assert.deepEqual(b, bAnswer);
  },
  ...
  testKrackhardtKiteGraphNormalized: function testKrackhardtKiteGraphNormalized() {
    var G = (0, _generators.krackhardtKiteGraph)();
...
var testWeightedBetweennessCentrality = {
  ...
  testK5: function testK5() {
    var G = (0, _generators.completeGraph)(5);
    var bAnswer = new Map({ 0: 0, 1: 0, 2: 0, 3: 0, 4: 0 });
    var b = (0, _betweenness.betweennessCentrality)(G, { weight: 'weight', normalized: false });
    b.forEach(function (v, k) {
      return assert.almostEqual(v, bAnswer.get(k));
    });
  },
  ...
  testP3Normalized: function testP3Normalized() {
    var G = (0, _generators.pathGraph)(3);
    var bAnswer = new Map({ 0: 0, 1: 1, 2: 0 });
    var b = (0, _betweenness.betweennessCentrality)(G, { weight: 'weight', normalized: true });
    b.forEach(function (v, k) {
      return assert.almostEqual(v, bAnswer.get(k));
    });
  },
...
var testEdgeBetweennessCentrality = {
  ...
  testk5: function testk5() {
    ...
    var G = (0, _generators.completeGraph)(5);
    var edge;
    var bAnswer = new Map(_regeneratorRuntime.mark(function callee$1$0() {
      var _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, _edge;
    ...
    var b = (0, _betweenness.edgeBetweennessCentrality)(G, { weight: null, normalized: false });
    assert.deepEqual(b, bAnswer);
  },
  ...
  testNormalizedK5: function testNormalizedK5() {
    ...
    var edge;
    var bAnswer = new Map(_regeneratorRuntime.mark(function callee$1$0() {
      var _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, _edge2;
    ...
    var b = (0, _betweenness.edgeBetweennessCentrality)(G, { weight: null, normalized: true });
    assert.deepEqual(b, bAnswer);
  },
  ...
  testC4: function testC4() {
    ...
    var edge;
    var bAnswer = new Map(_regeneratorRuntime.mark(function callee$1$0() {
      var _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, _edge3;
...
var testWeightedEdgeBetweennessCentrality = {
  ...
  testK5: function testK5() {
    ...
    var edge;
    var bAnswer = new Map(_regeneratorRuntime.mark(function callee$1$0() {
      var _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, _edge4;
    ...
    var b = (0, _betweenness.edgeBetweennessCentrality)(G, { weight: 'weight', normalized: false });
    assert.deepEqual(b, bAnswer);
  },
  ...
  testC4: function testC4() {
    ...
    var edge;
    var bAnswer = new Map(_regeneratorRuntime.mark(function callee$1$0() {
      var _iteratorNormalCompletion5, _didIteratorError5, _iteratorError5, _iterator5, _step5, _edge5;
  ...
  testNormalizedWeightedGraph: function testNormalizedWeightedGraph() {
    ...
    G.addWeightedEdgesFrom(eList);
    var bAnswer = new Map([[[0, 1], 0], [[0, 2], 1], [[0, 3], 2], [[0, 4], 1], [[1, 2], 2], [[1, 3], 3.5], [[1, 4], 1.5], [[2, 4], 1], [[3, 4], 0.5]]);
    var b = (0, _betweenness.edgeBetweennessCentrality)(G, { weight: 'weight', normalized: true });
