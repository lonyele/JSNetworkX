...
var testIsArrayLike = {
  ...
  'objects with a numeric length property': function objectsWithANumericLengthProperty() {
    var obj = { length: 3 };
    assert((0, _isArrayLike2['default'])(obj));
  },

  'not objects with a non-numeric length property': function notObjectsWithANonNumericLengthProperty() {
    var obj = { length: 'foo' };
    assert(!(0, _isArrayLike2['default'])(obj));
  },
