...
var testToObjectFromKeys = {
  'without default value (null)': function withoutDefaultValueNull() {
    ...
    assert.deepEqual((0, _toObjectFromKeys2['default'])(keys), { foo: null, bar: null, baz: null });
  },

  'with default value': function withDefaultValue() {
    var keys = ['foo', 'bar', 'baz'];
    assert.deepEqual((0, _toObjectFromKeys2['default'])(keys, 42), { foo: 42, bar: 42, baz: 42 });
  }
};
