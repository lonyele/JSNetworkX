  ...
  */
  ...
  testMaxIter: function testMaxIter() {
    assert.throws(function () {
      return (0, _eigenvector.eigenvectorCentrality)((0, _generators.pathGraph)(3), { maxIter: 0 });
    });
  }
};
...
var testEigenvectorCentralityDirected = {
  beforeEach: function beforeEach() {
    ...
    this.G = G.reverse();
    this.G.evc = new _Map([[1, 0.25368793], [2, 0.19576478], [3, 0.32817092], [4, 0.40430835], [5, 0.48199885], [6, 0.15724483], [7, 0.51346196], [8, 0.32475403]]);

    var H = new _classes.DiGraph();
    edges = [[1, 2], [1, 3], [2, 4], [3, 2], [3, 5], [4, 2], [4, 5], [4, 6], [5, 6], [5, 7], [5, 8], [6, 8], [7, 1], [7, 5], [7, 8], [8, 6], [8, 7]];
    H.addEdgesFrom(edges);
    this.H = H.reverse();
    this.H.evc = new _Map([[1, 0.25368793], [2, 0.19576478], [3, 0.32817092], [4, 0.40430835], [5, 0.48199885], [6, 0.15724483], [7, 0.51346196], [8, 0.32475403]]);
  },
  ...
  testEigenvectorCentralityWeighted: function testEigenvectorCentralityWeighted() {
    ...
    try {
      for (var _iterator4 = _getIterator(this.G), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
        var n = _step4.value;
  ...
  testEigenvectorCentralityUnWeighted: function testEigenvectorCentralityUnWeighted() {
    ...
    try {
      for (var _iterator5 = _getIterator(this.H), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
        var n = _step5.value;
