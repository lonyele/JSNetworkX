...
var testDelegateSync = {
  ...
  'it passes the arguments to the delegated function': function itPassesTheArgumentsToTheDelegatedFunction(done) {
    // istanbul ignore next

    var _this2 = this;

    var promise = (0, _delegateSync2['default'])('testFunction', ['foo', 'bar']);
  ...
  'it resolves to the return value of the delegated function': function itResolvesToTheReturnValueOfTheDelegatedFunction() {
  ...
  'it rejects if the delegated function throws an error': function itRejectsIfTheDelegatedFunctionThrowsAnError() {
    this.testFunction = function () {
