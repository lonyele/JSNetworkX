...
var testToMapFromKeys = {
  'without default value (null)': function withoutDefaultValueNull() {
    ...
    assert.deepEqual((0, _toMapFromKeys2['default'])(keys), new _Map2['default']({ foo: null, bar: null, baz: null }));
  },

  'with default value': function withDefaultValue() {
    var keys = ['foo', 'bar', 'baz'];
    assert.deepEqual((0, _toMapFromKeys2['default'])(keys, 42), new _Map2['default']({ foo: 42, bar: 42, baz: 42 }));
  }
};
