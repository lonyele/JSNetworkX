...
var testFunction = {
  beforeEach: function beforeEach() {
    this.G = new _Graph2['default']({ 0: [1, 2, 3], 1: [1, 2, 0], 4: [] }, { name: 'Test' });
  ...
  testNodesIter: function testNodesIter() {
    assert.deepEqual(_Array$from(this.G.nodesIter()), _Array$from(funcs.nodesIter(this.G)));
    assert.deepEqual(_Array$from(this.DG.nodesIter()), _Array$from(funcs.nodesIter(this.DG)));
  },

  testEdgesIter: function testEdgesIter() {
    assert.deepEqual(_Array$from(this.G.edgesIter()), _Array$from(funcs.edgesIter(this.G)));
    assert.deepEqual(_Array$from(this.DG.edgesIter()), _Array$from(funcs.edgesIter(this.DG)));
    assert.deepEqual(_Array$from(this.G.edgesIter([0, 1, 3])), _Array$from(funcs.edgesIter(this.G, [0, 1, 3])));
    assert.deepEqual(_Array$from(this.DG.edgesIter([0, 1, 3])), _Array$from(funcs.edgesIter(this.DG, [0, 1, 3])));
  },
