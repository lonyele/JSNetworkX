...
exports['default'] = _Object$assign({}, _BaseAttrGraphTester2['default'], {
  ...
  testAdjacencyIter: function testAdjacencyIter() {
    var G = this.K3;
    assert.deepEqual(_Array$from(G.adjacencyIter()), [[0, new Map({ 1: { 0: {} }, 2: { 0: {} } })], [1, new Map({ 0: { 0: {} }, 2: { 0: {} } })], [2, new Map({ 0: { 0: {} }, 1: { 0: {} } })]]);
  },
  ...
  testEdgeAttr4: function testEdgeAttr4() {
    ...
    assert.deepEqual(G.edges(true), [[1, 2, { data: 20, spam: 'bar', bar: 'foo', listdata: [20, 200], weight: 20 }]]);
  }
});
