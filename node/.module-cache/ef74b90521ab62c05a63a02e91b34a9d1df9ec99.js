...
var testBinary = {
  testUnionAttributes: function testUnionAttributes() {
    ...
    try {
      for (var _iterator = _getIterator(gh), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var n = _step.value;
  ...
  testDifferenceThrows: function testDifferenceThrows() {
    assert.throws(function () {
      return (0, _binary.difference)((0, _generatorsClassic.pathGraph)(4), (0, _generatorsClassic.pathGraph)(3));
    });
  },
  ...
  testUnionMultiGraph: function testUnionMultiGraph() {
    ...
    assert.deepEqual(new _internalsSet2['default'](GH), (0, _internalsSet.union)(new _internalsSet2['default'](G), new _internalsSet2['default'](H)));
    assert.deepEqual(new _internalsSet2['default'](GH.edges(false, true)), (0, _internalsSet.union)(new _internalsSet2['default'](G.edges(false, true)), new _internalsSet2['default'](H.edges(false, true))));
  },
  ...
  testMixedTypeUnion: function testMixedTypeUnion() {
    assert.throws(function () {
      return (0, _binary.union)(new _classes.Graph(), new _classes.MultiGraph());
    }, _exceptions.JSNetworkXError);
  },

  testMixedTypeDisjointUnion: function testMixedTypeDisjointUnion() {
    assert.throws(function () {
      return (0, _binary.disjointUnion)(new _classes.Graph(), new _classes.MultiGraph());
    }, _exceptions.JSNetworkXError);
  },

  testMixedTypeIntersection: function testMixedTypeIntersection() {
    assert.throws(function () {
      return (0, _binary.intersection)(new _classes.Graph(), new _classes.MultiGraph());
    }, _exceptions.JSNetworkXError);
  },

  testMixedTypeDifference: function testMixedTypeDifference() {
    assert.throws(function () {
      return (0, _binary.difference)(new _classes.Graph(), new _classes.MultiGraph());
    }, _exceptions.JSNetworkXError);
  },

  testMixedTypeSymmetricDifference: function testMixedTypeSymmetricDifference() {
    assert.throws(function () {
      return (0, _binary.symmetricDifference)(new _classes.Graph(), new _classes.MultiGraph());
    }, _exceptions.JSNetworkXError);
  },
