...
var testMapSequence = {
  'from array': function fromArray() {
    assert.deepEqual((0, _mapSequence2['default'])([1, 2, 3], function (x) {
      return x * 3;
    }), [3, 6, 9]);
  },

  'from array-like': function fromArrayLike() {
    assert.deepEqual((0, _mapSequence2['default'])({ 0: 1, 1: 2, 2: 3, length: 3 }, function (x) {
      return x * 3;
    }), [3, 6, 9]);
  },

  'from iterator': function fromIterator() {
    var iterator = (0, _mapSequence2['default'])(generator([1, 2, 3]), function (x) {
      return x * 3;
    });
    var result = [];
  ...
  'from object': function fromObject() {
    assert.deepEqual((0, _mapSequence2['default'])({ foo: 1, bar: 2 }, function (x) {
      return x * 3;
    }), { foo: 3, bar: 6 });
  }
};
