...
exports['default'] = {
  ...
  testNodesIter: function testNodesIter() {
    ...
    assert.sameMembersDeep(_Array$from(G.nodesIter(true)), [[0, {}], [1, {}], [2, {}]]);
  },
  ...
  testEdgesIter: function testEdgesIter() {
    ...
    assert.deepEqual(_Array$from(G.edgesIter()).sort(), [[0, 1], [0, 2], [1, 2]]);
    assert.deepEqual(_Array$from(G.edgesIter(0)).sort(), [[0, 1], [0, 2]]);
    assert.throws(function () {
  ...
  testDegreeIter: function testDegreeIter() {
    ...
    assert.deepEqual(_Array$from(G.degreeIter()), [[0, 2], [1, 2], [2, 2]]);
  ...
  testAddStar: function testAddStar() {
    ...
    assert.deepEqual(G.edges(nlist, true), [[12, 13, { weight: 2 }], [12, 14, { weight: 2 }], [12, 15, { weight: 2 }]]);
  },
  ...
  testAddPath: function testAddPath() {
    ...
    var nlist = [12, 13, 14, 15];
    G.addPath(nlist);
    assert.deepEqual(_Array$from(G.edges(nlist)), [[12, 13], [13, 14], [14, 15]]);
    G = this.K3.copy();
    G.addPath(nlist, { weight: 2 });
    assert.deepEqual(G.edges(nlist, true), [[12, 13, { weight: 2 }], [13, 14, { weight: 2 }], [14, 15, { weight: 2 }]]);
  },
  ...
  testAddCycle: function testAddCycle() {
    ...
    G = this.K3.copy();
    oklists = [[[12, 13, { weight: 1 }], [12, 15, { weight: 1 }], [13, 14, { weight: 1 }], [14, 15, { weight: 1 }]], [[12, 13, { weight: 1 }], [13, 14, { weight: 1 }], [14, 15, { weight: 1 }], [15, 12, { weight: 1 }]]];
