...
var testSomeIterator = function testSomeIterator() {
  assert.ok((0, _someIterator2['default'])(utils.genRange(10), function (x) {
    return x % 2 === 0;
  }));
  assert.ok(!(0, _someIterator2['default'])(utils.genRange(3), function (x) {
    return x === 5;
  }));
  assert.ok(!(0, _someIterator2['default'])(utils.genRange(0), function () {
    return true;
  }));
};
