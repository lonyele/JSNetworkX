...
var testZipSequence = {
  'zip arrays': function zipArrays() {
    assert.deepEqual((0, _zipSequence2['default'])([1, 2, 3], [4, 5, 6], [7, 8, 9]), [[1, 4, 7], [2, 5, 8], [3, 6, 9]]);
  },

  'zip arrays-like objects': function zipArraysLikeObjects() {
    assert.deepEqual((0, _zipSequence2['default'])({ length: 2, 0: 1, 1: 2 }, { length: 3, 0: 3, 1: 4, 2: 5 }), [[1, 3], [2, 4]]);
  },

  'zip iterators': function zipIterators() {
    assert.deepEqual(_Array$from((0, _zipSequence2['default'])(gen([1, 2, 3]), gen([4, 5]))), [[1, 4], [2, 5]]);
  }
