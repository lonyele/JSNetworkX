...
var randomGraphs = {
  ...
  testGnp: function testGnp() {
    this.timeout(5000);
    var generators = [_randomGraphs.gnpRandomGraph, _randomGraphs.binomialGraph, _randomGraphs.erdosRenyiGraph, _randomGraphs.fastGnpRandomGraph];
    var _iteratorNormalCompletion = true;
    var _didIteratorError = false;
    var _iteratorError = undefined;

    try {
      for (var _iterator = _getIterator(generators), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
