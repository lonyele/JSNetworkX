...
var Map = utils.Map;
exports['default'] = _lodash2['default'].extend({}, _BaseGraphTester2['default'], {
  ...
  testEdgesIter: function testEdgesIter() {
    var G = this.K3;
    assert.deepEqual(_Array$from(G.edgesIter()), [[0, 1], [0, 2], [1, 0], [1, 2], [2, 0], [2, 1]]);
    assert.deepEqual(_Array$from(G.edgesIter(0)), [[0, 1], [0, 2]]);
  },
  ...
  testOutEdgesIter: function testOutEdgesIter() {
    var G = this.K3;
    assert.deepEqual(_Array$from(G.outEdgesIter()), [[0, 1], [0, 2], [1, 0], [1, 2], [2, 0], [2, 1]]);
    assert.deepEqual(_Array$from(G.outEdgesIter(0)), [[0, 1], [0, 2]]);
  },
  ...
  testOutEdgesIterDir: function testOutEdgesIterDir() {
    var G = this.P3;
    assert.deepEqual(_Array$from(G.outEdgesIter()), [[0, 1], [1, 2]]);
  ...
  testInEdgesIterDir: function testInEdgesIterDir() {
    var G = this.P3;
    assert.deepEqual(_Array$from(G.inEdgesIter()), [[0, 1], [1, 2]]);
  ...
  testDegreeIter: function testDegreeIter() {
    var G = this.K3;
    assert.deepEqual(_Array$from(G.degreeIter()), [[0, 4], [1, 4], [2, 4]]);
  ...
  testInDegreeIter: function testInDegreeIter() {
    var G = this.K3;
    assert.deepEqual(_Array$from(G.inDegreeIter()), [[0, 2], [1, 2], [2, 2]]);
  ...
  testInDegreeIterWeighted: function testInDegreeIterWeighted() {
    ...
    assert.deepEqual(_Array$from(G.inDegreeIter(null, 'weight')), [[0, 2], [1, 1.3], [2, 2]]);
    ...
    assert.deepEqual(_Array$from(G.inDegreeIter(null, 'other')), [[0, 2], [1, 2.2], [2, 2]]);
  ...
  testOutDegreeIter: function testOutDegreeIter() {
    var G = this.K3;
    assert.deepEqual(_Array$from(G.outDegreeIter()), [[0, 2], [1, 2], [2, 2]]);
  ...
  testOutDegreeIterWeighted: function testOutDegreeIterWeighted() {
    var G = this.K3;
    G.addEdge(0, 1, { weight: 0.3, other: 1.2 });
    assert.deepEqual(_Array$from(G.outDegreeIter(null, 'weight')), [[0, 1.3], [1, 2], [2, 2]]);
    ...
    assert.deepEqual(_Array$from(G.outDegreeIter(null, 'other')), [[0, 2.2], [1, 2], [2, 2]]);
  ...
  testReverseCopy: function testReverseCopy() {
    var G = new _DiGraph2['default']([[0, 1], [1, 2]]);
    var R = G.reverse();
